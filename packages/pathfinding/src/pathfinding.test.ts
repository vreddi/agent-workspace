...
describe('manhattanDistance', () => {
  it('measures L1 distance between two cells including z', () => {
    expect(
      manhattanDistance({ x: 0, y: 0, z: 0 }, { x: 3, y: 4, z: 0 }),
    ).toBe(7);
    expect(
      manhattanDistance({ x: 2, y: 2, z: 1 }, { x: 2, y: 2, z: 1 }),
    ).toBe(0);
    expect(
      manhattanDistance({ x: -1, y: 0, z: 0 }, { x: 1, y: 0, z: 0 }),
    ).toBe(2);
    expect(
      manhattanDistance({ x: 0, y: 0, z: 0 }, { x: 0, y: 0, z: 3 }),
    ).toBe(3);
  });
});
